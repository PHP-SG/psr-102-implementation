...
use Psg\Http\Server\{MiddlewareInterface, MiddlewareNextInterface, MiddlewareAppInterface};
use Psg\Http\Server\{BeforewareInterface, AfterwareInterface, FrontwareInterface, BackwareInterface, LayeredAppInterface};
use Psg\Http\Message\{ExitResponseInterface};
use Psg\Http\Message\{ResponseInterface, ServerRequestInterface};


class LayeredApp extends Psr100Factory implements LayeredAppInterface{
	...
	latest response object exists at the top most layer, and the middleware
	...
	*/
	...
	\Psr\Http\Message\ServerRequestInterface , but it expects a Psg psr 100 ServerRequestInterface
	*/
